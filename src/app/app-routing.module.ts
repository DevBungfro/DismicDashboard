...
const routes: Routes = [
  ...
  { path: 'verysecretlink123456789654456778854', component: StatsComponent },
  ...
  { path: 'servers', component: DashboardOverviewComponent, canActivate: [DashboardAuthGuard] },
  ...
  { path: 'premium', component: PlusComponent },
